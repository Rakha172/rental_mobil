...
<div class="container mt-5">
    <form action="{{ route('barang.store') }}" method="post">
        ...
        <div class="mb-3">
            ...
            <input value="{{ old('vehicle_type') }}" name="vehicle_type" type="text"
        ...
        <div class="mb-3">
            ...
            <input value="{{ old('color') }}" name="color" type="text"
        ...
        <div class="mb-3">
            ...
            <input value="{{ old('passenger_capacity') }}" name="passenger_capacity" type="number"
        ...
        <div class="mb-3">
            ...
            <input value="{{ old('rental_price') }}" name="rental_price" type="text"
