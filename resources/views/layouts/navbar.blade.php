<nav class="navbar navbar-expand-lg bg-light">
    <div class="container-fluid">
        ...
        <a class="navbar-brand" href="{{ route('landingpage.index') }}">Rental Mobil</a>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="{{ route('vehicle_packages.index') }}">Vehicle Package</a></li>
                    </ul>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('login.index') }}">Logout As Admin?</a>
                </li>
            </ul>
