<nav x-data="{ open: false }" class="border-b border-gray-100 fixed w-full top-0 z-10"
    style="background-color:rgb(236, 128, 4);">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                <div class="font-medium text-base text-gray-800" style="font-size:10px; color:black;">
                    {{ Auth::user()->name }}</div>
